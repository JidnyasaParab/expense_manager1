...
// @dart = 2.12
import 'graphql/graphql.graphql.dart' as x0 show CreateItem$Mutation$Item, CreateItem$Mutation, ItemInput, DeleteItem$Mutation, GetItems$Query$Item, GetItems$Query, UpdateItem$Mutation$Item, UpdateItem$Mutation, CreateItemArguments, DeleteItemArguments, UpdateItemArguments;
import 'model/item.dart' as x1 show Item;
...
final mainGeneratedAdapter = JsonMapperAdapter(
  ...
  valueDecorators: {
    typeOf<List<x0.CreateItem$Mutation$Item>>(): (value) => value.cast<x0.CreateItem$Mutation$Item>(),
    typeOf<Set<x0.CreateItem$Mutation$Item>>(): (value) => value.cast<x0.CreateItem$Mutation$Item>(),
    typeOf<List<x0.CreateItem$Mutation>>(): (value) => value.cast<x0.CreateItem$Mutation>(),
    typeOf<Set<x0.CreateItem$Mutation>>(): (value) => value.cast<x0.CreateItem$Mutation>(),
    typeOf<List<x0.ItemInput>>(): (value) => value.cast<x0.ItemInput>(),
    typeOf<Set<x0.ItemInput>>(): (value) => value.cast<x0.ItemInput>(),
    typeOf<List<x0.DeleteItem$Mutation>>(): (value) => value.cast<x0.DeleteItem$Mutation>(),
    typeOf<Set<x0.DeleteItem$Mutation>>(): (value) => value.cast<x0.DeleteItem$Mutation>(),
    typeOf<List<x0.GetItems$Query$Item>>(): (value) => value.cast<x0.GetItems$Query$Item>(),
    typeOf<Set<x0.GetItems$Query$Item>>(): (value) => value.cast<x0.GetItems$Query$Item>(),
    typeOf<List<x0.GetItems$Query>>(): (value) => value.cast<x0.GetItems$Query>(),
    typeOf<Set<x0.GetItems$Query>>(): (value) => value.cast<x0.GetItems$Query>(),
    typeOf<List<x0.UpdateItem$Mutation$Item>>(): (value) => value.cast<x0.UpdateItem$Mutation$Item>(),
    typeOf<Set<x0.UpdateItem$Mutation$Item>>(): (value) => value.cast<x0.UpdateItem$Mutation$Item>(),
    typeOf<List<x0.UpdateItem$Mutation>>(): (value) => value.cast<x0.UpdateItem$Mutation>(),
    typeOf<Set<x0.UpdateItem$Mutation>>(): (value) => value.cast<x0.UpdateItem$Mutation>(),
    typeOf<List<x0.CreateItemArguments>>(): (value) => value.cast<x0.CreateItemArguments>(),
    typeOf<Set<x0.CreateItemArguments>>(): (value) => value.cast<x0.CreateItemArguments>(),
    typeOf<List<x0.DeleteItemArguments>>(): (value) => value.cast<x0.DeleteItemArguments>(),
    typeOf<Set<x0.DeleteItemArguments>>(): (value) => value.cast<x0.DeleteItemArguments>(),
    typeOf<List<x0.UpdateItemArguments>>(): (value) => value.cast<x0.UpdateItemArguments>(),
    typeOf<Set<x0.UpdateItemArguments>>(): (value) => value.cast<x0.UpdateItemArguments>(),
    typeOf<List<x1.Item>>(): (value) => value.cast<x1.Item>(),
    typeOf<Set<x1.Item>>(): (value) => value.cast<x1.Item>()
},
  enumValues: {
